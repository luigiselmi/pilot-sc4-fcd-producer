...
# 2) Start a container 
#
#    $ docker run -d --network pilot-sc4 --name fcd-producer -v /data/fcd-sample-data.csv.gz:/data/fcd-sample-data.csv.gz:ro  bde2020/pilot-sc4-fcd-producer:v0.0.1 
...
ENV FLINK_APPLICATION_ARGS "--path /data/fcd-sample-data.csv.gz --topic taxi"
